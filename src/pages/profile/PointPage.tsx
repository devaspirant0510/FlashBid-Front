...
import {UserPointHeader, UserPointSummaryCards, UserPointFilterBar, UserPointTable, UserPointCountFooter} from "@/widgets/user";
                ...
                {(data) => {
                    ...
                    return (
                        <div className="w-full p-6 space-y-6">
                            ...
                            <UserPointSummaryCards totalEarned={totalEarned} totalSpent={totalSpent}/>
                            ...
                            <UserPointCountFooter total={data.length} visible={filteredData.length}/>
                        </div>
                    );
                }}
            </FetchMyPointHistory>
