...
export const EditModal = ({ feedId, initialContent, initialImages, onClose }: EditModalProps) => {
    ...
    const [allImages, setAllImages] = useState<
        (FileWithPreview | (ExistingImage & { isExisting: true }))[]
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast(`실패: ${error.response?.data?.message || error.message}`);
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className='fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4'>
            ...
            >
                ...
                <h2 className='text-center text-gray-800 text-2xl font-bold mb-6'>게시글 수정</h2>
