...
const RegisterPage = () => {
    ...
    const inputBaseStyle =
        'w-full p-3 text-sm bg-gray-50 border border-gray-200 rounded-md focus:outline-orange-400';
    const labelStyle = 'font-semibold text-gray-700';
    const verifyBtnStyle =
        'bg-orange-200 text-sm font-bold text-gray-800 px-4 py-2 rounded-md hover:bg-orange-300 transition-colors whitespace-nowrap';
            ...
            <div className='max-w-4xl mx-auto my-10 p-10 bg-gray-50 text-gray-800 rounded-lg shadow-md'>
                ...
                <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        {emailCheck.message && (
                            <p
                                className={`text-xs mt-1 ${emailCheck.checked ? 'text-green-600' : 'text-red-600'}`}
                            >
                                {emailCheck.message}
                            </p>
                        )}
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input
                            ...
                            value={form.password}
                            onChange={handleChange}
                            className={`${inputBaseStyle} max-w-sm`}
                        />
                        <input
                            type='password'
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        {nicknameCheck.message && (
                            <p
                                className={`text-xs mt-1 ${nicknameCheck.checked ? 'text-green-600' : 'text-red-600'}`}
                            >
                                {nicknameCheck.message}
                            </p>
                        )}
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='border-y border-orange-500 py-4 flex flex-col gap-3'>
                            ...
                            <p className='text-xs text-orange-500 ml-8'>
                                만 14세 미만의 회원 가입은 법정대리인 동의가 필요합니다
                            </p>
                            <label className='flex items-center gap-2 cursor-pointer ml-2'>
                                <input
                                    type='checkbox'
