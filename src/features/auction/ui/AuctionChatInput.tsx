...
import {ImageIcon, MessageSquareIcon, MessageSquareTextIcon, SendIcon, SmileIcon} from "lucide-react";
    ...
    return (
        <form>
            ...
            <div className={'p-3 border-1 rounded-xl mt-8 shadow-sm'}>
                <div className={"text-[#F7A17E] flex text-sm items-center gap-1 mb-1"}><MessageSquareTextIcon size={15}
                                                                                                              className={"text-[#F7A17E]"}/>채팅
                </div>
                <div className={"flex"}>
                    <Input className={'border-none'} value={message} onChange={onChangeMessage}
